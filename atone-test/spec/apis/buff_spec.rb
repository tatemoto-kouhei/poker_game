require "/Users/k.tatemoto/rails-project/atone-test/app/services/buff.rb"
...
describe PokerGame do
  ...
  context "with invalid input" do
    it "raises an error and sets an error message for invalid cards" do
      ...
      expect(poker_game.players[0].error_message).to eq("Invalid card: X1")
    end
